...
- Массовая генерация учётных записей участников (`/samatumarurmat/generate-users/`)
...
- `/samatumarurmat/` — админка
- `/samatumarurmat/generate-users/` — массовая генерация учёток участников
