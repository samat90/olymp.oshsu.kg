...
from judge.views.generate_users import GenerateUsersView
...
urlpatterns = [
    ...
    path('500/', exception),
    path('samatumarurmat/generate-users/', GenerateUsersView.as_view(), name='admin_generate_users'),
    path('samatumarurmat/', admin.site.urls),
